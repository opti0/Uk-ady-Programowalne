...
HD_PWD='C:/Users/Maciek/Documents/BINTO7SEG/BINTO7SEG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BINTO7SEG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BINTO7SEG.tcl
