...
HD_PWD='C:/Users/Maciek/Documents/SUM1B/SUM1B.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SUM4B.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SUM4B.tcl
