...
HD_PWD='C:/Users/Maciek/Documents/uklady_programowalne/ipintegrator/ipintegrator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log modsystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source modsystem_wrapper.tcl
